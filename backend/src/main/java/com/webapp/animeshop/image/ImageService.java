package com.webapp.animeshop.image;
...
public class ImageService implements WebMvcConfigurer{
	...
	private static final Path FILES_FOLDER = Paths.get(System.getProperty("user.dir/"), "image");

	@Override
	public void addResourceHandlers(ResourceHandlerRegistry registry) {

		registry.addResourceHandler("/image/**")
				.addResourceLocations("file:" + FILES_FOLDER.toAbsolutePath().toString() + "/img");
