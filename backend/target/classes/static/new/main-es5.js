      ...
      _createClass(UserEditComponent, [{
        ...
        value: function saveInfo() {
          ...
          this.service.saveUser(this.user).subscribe(function (user) {
            ...
            _this30.router.navigate(['/userPage/' + _this30.service.getCurrentUserId()]);
          }, function (error) {
            return console.log(error);
          });
        }
    ...
    = /*#__PURE__*/function () {
      function UserPageComponent(router, activatedRoute, service, oService) {
        ...
        oService.getAllMetrics().subscribe(function (metrics) {
          _this31.metrics = metrics, _this31.lastMetric = _this31.metrics[_this31.metrics.length - 1], _this31.average = _this31.lastMetric.average, _this31.lastMetric.averageToPrint = _this31.lastMetric.average.toFixed(2), _this31.metrics.shift();
        }, function (error) {
          return console.log(error);
        });
        oService.getMetrics;
    ...
    var CheckoutComponent = /*#__PURE__*/function () {
      ...
      _createClass(CheckoutComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.orderService.getCurrentOrder().subscribe(function (order) {
            _this33.order = order;
            _this33.totalaux = order.total + _this33.tax;
            if (_this33.order.productList.length == 0) _this33.router.navigate(['/product']);
          }, function (error) {
            return console.log(error);
          });
      ...
      _createClass(ConfirmationComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.loginService.getUserById(this.loginService.user.id).subscribe(function (user) {
            ...
            if (_this35.order.productList.length == 0) _this35.router.navigate(['/product']);
          }, function (error) {
            return console.log(error);
          });
    ...
    var ProductComponent = /*#__PURE__*/function () {
      ...
      _createClass(ProductComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.service.getAllProducts().subscribe(function (products) {
            return _this52.getFranchisesAndDistributors(products);
          }, function (error) {
            return console.log(error);
          });
          ...
          this.service.getProductsbyRecommendations().subscribe(function (recommendedProducts) {
            return _this52.recommendedProducts = recommendedProducts;
          }, function (error) {
            return console.log(error);
          });
          this.orderService.getCurrentOrder().subscribe(function (order) {
            return _this52.order = order;
          }, function (error) {
            return console.log(error);
          });
        }
        ...
        value: function sortBy(toDo, sort) {
          ...
          if (toDo == "") this.service.getAllProducts().subscribe(function (products) {
            _this53.products = products;
            _this53.sorting = false;
            _this53.filterqty = 99;
          }, function (error) {
            return console.log(error);
        ...
        value: function search(key) {
          ...
          this.service.getProductsbyKey('search', key, 0).subscribe(function (products) {
            ...
            _this54.service.getProductsbyKey('search', key, _this54.page).subscribe(function (products) {
              _this54.productsAux = products;
              if (_this54.productsAux.length == 0) _this54.lastpage = true;
            }, function (error) {
              return console.log(error);
            });
          }, function (error) {
        ...
        value: function saveProduct() {
          ...
          this.service.saveProduct(this.newProduct).subscribe(function (product) {
            _this56.service.getProductsbyPage(_this56.page).subscribe(function (products) {
              _this56.getFranchisesAndDistributors(products);
            }, function (error) {
              return console.log(error);
            });
          }, function (error) {
        ...
        value: function filter() {
          ...
          this.service.getProductsbyFilter(this.franchise, this.distributor, this.width, this.height, this.min, this.value).subscribe(function (products) {
            _this57.products = products;
            _this57.filterqty = products.length;
          }, function (error) {
            return console.log(error);
          });
        }
        ...
        value: function loadMore() {
          ...
          this.service.getProductsbyPage(this.page).subscribe(function (products) {
            if (_this59.sorting == true) {
              if (_this59.sortingMethod == false) {
                _this59.service.getProductsbySort("sort", "desc", _this59.page).subscribe(function (products) {
                  return _this59.products = _this59.products.concat(products);
                }, function (error) {
                  return console.log(error);
                });
              } else {
                _this59.service.getProductsbySort("sort", "asc", _this59.page).subscribe(function (products) {
                  return _this59.products = _this59.products.concat(products);
                }, function (error) {
                  return console.log(error);
                });
              ...
              _this59.service.getProductsbyPage(_this59.page).subscribe(function (products) {
                _this59.productsAux = products;
                if (_this59.productsAux.length == 0) _this59.lastpage = true;
              }, function (error) {
                return console.log(error);
              });
            } else if (_this59.searching) {
              _this59.service.getProductsbyKey('search', _this59.searchkey, _this59.page).subscribe(function (products) {
                _this59.products = _this59.products.concat(products);
                _this59.filterqty = products.length;
              }, function (error) {
                return console.log(error);
              });
            } else {
              ...
              if (_this59.productsAux.length != 0) {
                _this59.products = _this59.products.concat(_this59.productsAux);
                _this59.page += 1;

                _this59.service.getProductsbyPage(_this59.page).subscribe(function (products) {
                  _this59.productsAux = products;
                  if (_this59.productsAux.length == 0) _this59.lastpage = true;else _this59.service.getProductsbyPage(_this59.page).subscribe(function (products) {
                    return _this59.getFranchisesAndDistributors(products);
                  }, function (error) {
                    return console.log(error);
                  });
                }, function (error) {
    ...
    var SingleProductComponent = /*#__PURE__*/function () {
      function SingleProductComponent(router, activatedRoute, service, loginService, orderService) {
        ...
        service.getProductById(id).subscribe(function (product) {
          return _this70.product = product;
        }, function (error) {
          return console.error(error);
        });
      }
      ...
      _createClass(SingleProductComponent, [{
        ...
        value: function deleteProduct() {
          ...
          this.service.deleteProduct(this.product).subscribe(function (_) {
            return _this72.router.navigate(['/product']);
          }, function (error) {
            return console.error(error);
          });
        }
