...
public class DatabaseInitializer {
	...
	private void initDatabase() {
		...
		this.productService.addProduct(new Product("Funko Pop! -Titan Colosal","Attack on Titans",17.99,"Del divertido fabricante Funko, nos llegan las irresistibles Pop! figuras de colección de Videojuegos, Cine, Televisión...\\r\\n\" + \r\n" + 
				"				\"\\r\\n\" + \r\n" + 
				"				\"Son fantásticas para coleccionar, y es que cuando haces POP! ya no hay stop!. Quedáis avisados…",40,19,200,"Funko Pop!","TM0ZZH441XC005",80, "/img/product/titanColosal.png", "/img/product/titanColosal2.jpg"));
		
		this.productService.addProduct(new Product("Charlotte Katakuri(Figuarts ZERO)","One Piece",69.99,"Esta fantástica figura está fabricada en PVC y mide aproximadamente 22 centímetros de alto. Charlotte aparece sosteniendo su arma, un tridente que recibe el nombre de Mogura",15,20,400,"Figuarts ZERO","TM0ZZH441XB006",90, "/img/product/katakuri.png", "/img/product/katakurifull.jpg"));
		this.productService.addProduct(new Product("Funko Pop! - Chopper","One Piece",56.75,"Figura de la línea POP! de Chopper. Basada en el universo de One Piece creado por Eiichiro Oda, tiene una altura aproximada de 10cm.",17,30,650,"Funko Pop!","TM0ZZH441XB007",75, "/img/product/chopper.png", "/img/product/chopper2.jpg"));
		this.productService.addProduct(new Product("Jinbei (Figuarts ZERO)","One Piece",80.20,"Figura de Jinbei \"El Caballero del Mar\", el hombre-pez de One Piece, fabricada por Bandai-Tamashii Nations para su colección Figuarts ZERO",25,40,500,"Figuarts ZERO","TM0ZZH441XB008",60, "/img/product/Jinbei.png", "/img/product/Jinbei2.jpg"));
		this.productService.addProduct(new Product("Luffy (Figuarts ZERO)","One Piece",35.50,"Figura de Monkey D. Luffy, el protagonista de One Piece, perteneciente a la colección Figuarts ZERO de Bandai - Tamashii Nations.",30,25,750,"Figuarts ZERO","TM0ZZH441XB009",87, "/img/product/Luffy.png", "/img/product/Luffy2.jpg"));
		this.productService.addProduct(new Product("Zoro (Figuarts ZERO)","One Piece",70.00,"Figura de Zoro, personaje de One Piece, perteneciente a la colección Figuarts ZERO de Bandai - Tamashii Nations, ejecutando su espectacular técnica de ataque.",30,30,835,"Figuarts ZERO","TM0ZZH441XB010",120, "/img/product/Zoro.png", "/img/product/Zoro2.jpg"));
		
		this.productService.addProduct(new Product("Funko Pop! - Kakashi","Naruto",17.50,"Una nueva oleada de figuras de “Naruto: Shippuden”, el manga/serie de Anime llega a Kabenzots! Nuevo Funko Pop Kakashi. Representa a Kakashi Hatake, un Jōnin de Konoha",5,9,200,"Funko Pop!","TM0ZZH441XC011",70, "/img/product/funko-pop-kakashi.png", "/img/product/funko-pop-kakashi2.png"));
